...
struct abstract_factory {
  ...
  virtual std::unique_ptr<game_input> make_game_input() const = 0;
  virtual std::unique_ptr<game_output> make_game_output() const = 0;
  virtual std::unique_ptr<window_input> make_window_input() const = 0;
  virtual std::unique_ptr<window_output> make_window_output() const = 0;
  virtual std::unique_ptr<snake_input> make_snake_input() const = 0;
